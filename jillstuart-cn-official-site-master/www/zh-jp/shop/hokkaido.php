...
<meta name="keywords" content="Hokkaido, Tohoku,Japan,Shop List,<? include($_SERVER['DOCUMENT_ROOT'].$_lang."/>includes/keywords.php"); ?>"><title>北海道与东北地区|日本|商铺名单|<? include($_SERVER['DOCUMENT_ROOT'].$_lang."/includes/title.php"); ?></title><? include($_SERVER['DOCUMENT_ROOT']."/includes/meta.php"); ?><? include($_SERVER['DOCUMENT_ROOT']."/includes/misc.php"); ?><link rel="stylesheet" media="all" href="/common/css/second.css" />
...
<meta property="og:url" content="http://<? echo $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"] ?>" /><meta property="og:description" content="Shop List (Hokkaido, Tohoku - Japan)">
...
<body <? if(is_smartphone()) { echo 'class="smartphone"'; } ?>><?php include_once($_SERVER['DOCUMENT_ROOT']."/includes/analyticstracking.php"); ?><div class="container "><? include($_SERVER['DOCUMENT_ROOT'].$_lang."/includes/header.php"); ?><main role="main" class="">
		<h1><a href="<? echo $_lang; ?>/shop/"">商铺名单</a></h1><? $p_category = "Hokkaido &amp; Tohoku - Japan" ?><? include($_SERVER['DOCUMENT_ROOT']. $_lang . "/shop/includes/shop_category_navi.php"); ?><div class="main_inner">

		<article id="content"><a id="hokkaidou" name="hokkaidou"></a><div class="shoplist">
	...
	<ul>
		<li>
			<h5>札幌</h5>
			<address>4-7, Kita Gojyo Nishi, Chuo-ku, Sapporo City, Hokkaido, 060 - 0005<br />电话：011-241-5376</address>
		</li>
	</ul>
</div><a id="miyagi" name="miyagi"></a><div class="shoplist">
	<div class="fac_header">
		<h4>宫城县</h4>
	</div>
	<ul>
		<li>
			...
			<address>1-4-1 2F, Izumi Chuo, Izumi-ku, Sendai City, Miyagi Pref, 981-3133<br />电话：022-371-0135</address><!--
			<div class="news">
		...
		<li>
			...
			<address>3-6-11, Ichiban Town, Aoba-ku, Sendai City, Miyagi Pref, 980-0811<br />电话：022-221-5588</address>
		</li>
		<li>
			<h5>Perfumerie Sukiya S-PAL</h5>
			<address>1-1-1 1F, Chuo , Aoba-ku, Sendai City, Miyagi Pref, 980-0021<br />电话：022-214-3777</address>
		</li>
	</ul>
</div>
