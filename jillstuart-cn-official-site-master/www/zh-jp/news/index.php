...
<meta name="keywords" content="<? include($_SERVER['DOCUMENT_ROOT'].$_lang."/includes/keywords.php"); ?>"><title>最新资讯 |<? include($_SERVER['DOCUMENT_ROOT'].$_lang."/includes/title.php"); ?></title><? include($_SERVER['DOCUMENT_ROOT']."/includes/meta.php"); ?><? include($_SERVER['DOCUMENT_ROOT']."/includes/misc.php"); ?><link rel="stylesheet" media="all" href="/common/css/second.css" />
...
<meta property="og:title" content="NEWS - JILL STUART Beauty 公式サイト">
...
<main role="main" class="">
    <h1><a href="<? echo $_lang; ?>/news/">最新资讯</a>
  <?
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#block_00058").insertBefore("#block_00059");
	});
