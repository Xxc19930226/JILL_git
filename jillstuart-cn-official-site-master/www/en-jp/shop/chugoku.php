...
<meta name="keywords" content="Chugoku, Shikoku ,Japan,Shop List,<? include($_SERVER['DOCUMENT_ROOT'].$_lang."/includes/keywords.php"); ?>">
<title>Chugoku & Shikoku | Japan | Shop List | <? include($_SERVER['DOCUMENT_ROOT'].$_lang."/includes/title.php"); ?></title>
...
<meta property="og:description" content="Shop List (Chugoku, Shikoku - Japan)">
...
<? include($_SERVER['DOCUMENT_ROOT'].$_lang."/includes/header.php"); ?>
	...
	<main role="main" class="">
		...
		<? $p_category = "Chugoku &amp; Shikoku - Japan" ?>
...
<div class="shoplist">
	...
	<ul>
		<li>
			<h5>flance-ya</h5>
			<address>
			YALEYALE A B2F, 9-1, Matsubaracho, Minami-ku, Hiroshima City, Hiroshima Pref, 732-0822<br />
			Tel : 082-261-5333
			</address>
			<!--
			<div class="news">
		...
		<li>
			<h5>LOOK SUN-STE</h5>
			<address>
			SUN-STE 1F, Sannomarucho, Fukuyama City, Hiroshima Pref, 720-0066<br />
			Tel : 084-927-2173
			</address>
		</li>
		<li>
			<h5>
				jour france-ya</h5>
			<address>
				Hiroshima Zero Gate 1F, 2-7, Shintenchi, Naka-ku, Hiroshima City, Hiroshima Pref, 730-0034<br>
				Tel : 082-247-2320</address>
		</li>
	</ul>
</div>
<a id="tokushima" name="tokushima"></a>
<div class="shoplist">
	<div class="fac_header">
		<h4>
		Tokushima
	...
	<ul>
		<li>
			...
			<address>
			645, Muyacho Minamihama Aza Higashi Town, Naruto City, Tokushima Pref, 772-0003<br />
			Tel : 088-685-0101
			</address>
		</li>
	</ul>
</div>
<a id="kagawa" name="kagawa"></a>
<div class="shoplist">
	<div class="fac_header">
		<h4>
		Kagawa
	...
	<ul>
		<li>
			...
			<address>
			12-4, Marukamecho, Takamatsu City, Kagawa Pref, 760-0029<br />
			Tel : 087-821-9080
			</address>
		</li>
	</ul>
</div>
<a id="ehime" name="ehime"></a>
<div class="shoplist">
	<div class="fac_header">
		<h4>
		Ehime
	...
	<ul>
		<li>
			<h5>FUJIKAWA Gintengai</h5>
			<address>
			4-6-9, Minatomachi, Matsuyama City, Ehime Pref, 790-0012<br />
			Tel : 089-945-5111
			</address>
		</li>
	</ul>
